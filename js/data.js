...
define(["jquery"], function ($) {
  function download() {
    ...
    <div class = "home-brick-box home-brick-row-2-box xm-plain-box">
        ...
        $(".page-main .container").append(node);

        //循环添加子元素

        for (var i = 0; i < firstData.childs.length; i++) {
          var childNode = $(`<li class = 'brick-item brick-item-m brick-item-m-2'>
            <a href="#">
                <div class = 'figure figure-img'>
                    <img width="160" height="160" src="${
                      firstData.childs[i].img
                    }" alt=""/>
                </div>
                <h3 class = 'title'>
                ...
                <p class = 'price'>
                    ...
                    <span>起</span>
                    ${
                      firstData.childs[i].del == 0
                        ? ""
                        : "<del>" + firstData.childs[i].del + "元</del>"
                    }
                </p>
            </a>
        </li>`);
          node.find(".brick-list").append(childNode);
        }
        ...
        for (var i = 1; i < res.length; i++) {
                                      ...
                                      <div class = 'span4'>
                                          <ul class = 'brick-promo-list clearfix'>
                                              <li class = 'brick-item  brick-item-m'>
                                                  <a href="#">
                                                      <img src="${res[i].leftChilds[0]}" alt=""/>
                                                  </a>
                                              </li>
                                              <li class = 'brick-item  brick-item-m'>
                                                  <a href="#">
                                                      <img src="${res[i].leftChilds[1]}" alt=""/>
                                                  </a>
                                              </li>
                                          </ul>
                                      </div>
          ...
          $(".page-main .container").append(node2);
          //加载hotChilds
          var hotChilds = res[i].hotChilds;
          //热门部分商品放进去
          ...
          //k循环结束后把最后的加载更多插一遍进去
          node2.find(".span16 ul").eq(0).append(
          ...
          for (var l = 0; l < childs.length; l++) {
            node2
              ...
              .append(
                $(` <div>
                      <li class = 'brick-item ${
                        l == 7 ? "brick-item-s" : "brick-item-m brick-item-m-2"
                      }'>
                          <a href="#">
                              <div class = 'figure figure-img'>
                                  <img width="160" height="160" src="${
